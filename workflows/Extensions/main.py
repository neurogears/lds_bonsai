...
MODULE_ROOT = Path.cwd().parent / "modules"
EXTENSIONS_PATH = Path.cwd() / "Extensions"

sys.path.append(str(MODULE_ROOT))
sys.path.append(str(EXTENSIONS_PATH))

DEFAULT_CONFIG_PATH = MODULE_ROOT / "lds_python" / "metadata" / "00000009_smoothing.ini"


import configparser
import numpy as np
from lds_python.code.scripts import utils
from lds_python.code.src import inference
